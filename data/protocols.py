...
TEMPUS_PROTOCOL = "0x7e964a6811a4c68a414897db01fbdc86548992442bf2c39d7cfe5aa4669a71cc"
...
PROTOCOL_META = OrderedDict([
    (SQUEETH_PROTOCOL, {
        ...
        "agreement": "PUBLIC_Opyn_Statement_of_Coverage.pdf",
        "logo": "",
    ...
    (TEMPUS_PROTOCOL, {
        ...
        "agreement": "Tempus_Statement_of_Coverage.pdf",
        "logo": "",
        "desc": "Tempus is a multi-chain fixed-income protocol that integrates with lending protocols, staking protocols, and yield aggregators, and lets users fix or speculate on the yield generated by them.",
        "deductable": "0"
    }),
    (TELLER_PROTOCOL, {
...
def get_protocols_covered():
    return {
        ...
        "0x7e964a6811a4c68a414897db01fbdc86548992442bf2c39d7cfe5aa4669a71cc": {
            "tokens": {
            "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48": {
                "covered": 734000000000.0,
                "percentage": 100.0,
                "covered_str": "7.34M"
            }
            },
